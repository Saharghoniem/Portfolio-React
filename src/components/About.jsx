...
const About = () => {
  const skills = [
    ...
    { name: "WORDPRESS DEVELOPMENT", image: "/src/assets/icons/android.png" },
    {
  ...
  return (
    <div className="md:px-10 px-7 sm:-mt-24" id="about">
      ...
      <p className="my-3 text-white md:w-2/3 leading-[2]">
        Hi, my name is Sahar Ghoniem, i web developer, UI designer, wordpress
        developer ,I have honed my skills in Web Development and advance i have
      ...
      <div className="md:flex my-7 items-center">
        ...
        <p className="text-white text-2xl md:ml-5">
          Years of experience. Specialised in web,.
        </p>
      </div>
