...
const Contact = () => {
  return (
    <div className="md:px-10 px-7 my-10" id="contact">
      ...
      <p className="my-3 text-white md:w-3/4 leading-[2]">
      saharghoniem@icloud.com
      </p>
      {/* social icons */}
      <div className="flex ">
        <a href="https://www.facebook.com/profile.php?id=100082840249597" target="_blank" rel="noreferrer">
        ...
        <a className="ml-4" href="saharghoniem@icloud.com" target="_blank" rel="noreferrer">
        <img src={email} alt="" />
        </a>
      </div>
        </div>
